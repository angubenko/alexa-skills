...
function getWelcomeResponse(callback) {
    ...
    var sessionAttributes = {},
        //CHANGE THIS TEXT
        speechOutput = "This is Computer Science quiz app. Your test contains " + GAME_LENGTH.toString()
            + " questions. To answer just say the answer. Good luck! ",
...
function handleAnswerRequest(intent, session, callback) {
    ...
    if (!gameInProgress) {
        ...
        if (currentQuestionIndex == GAME_LENGTH - 1) {
            ...
            speechOutput += speechOutputAnalysis + "You answered " + currentScore.toString() + " out of "
                + GAME_LENGTH.toString() + " questions correct. Thank you for learning with us!";
            callback(session.attributes,
...
function handleFinishSessionRequest(intent, session, callback) {
    ...
    callback(session.attributes,
        buildSpeechletResponseWithoutCard("Thanks for playing!", "", true));
}
